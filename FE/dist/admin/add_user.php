...
<body>
    <?php
          ...
          {
              $firstnameErr = $lastnameErr = $usernameErr = $passwordErr = $emailErr = $phoneErr 
              ...
              else
              {
                  ...
                  if ($firstnameErr != "" || $lastnameErr != "" || $usernameErr != "" || $passwordErr != "" || $emailErr != "" 
                  ...
                  {            
                      ...
                      {   
                          $msg = "User added failed!";
                          $errList = $errList."Error query insert user: ".$connection->error."<br>";
                      }
                  }
